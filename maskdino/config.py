...
def add_maskdino_config(cfg):
    ...
    cfg.MODEL.BORDER_HEAD.ENABLED = False
    cfg.MODEL.BORDER_HEAD.TRAIN_ONLY = False
    cfg.MODEL.BORDER_HEAD.FREEZE_BASE = False
    cfg.MODEL.BORDER_HEAD.UNFREEZE_PIXEL_DECODER = False
    cfg.MODEL.BORDER_HEAD.HIDDEN_DIM = 128
    cfg.MODEL.BORDER_HEAD.IMAGE_HIDDEN_DIM = 32
    cfg.MODEL.BORDER_HEAD.FULL_RES_HIDDEN_DIM = 32
    cfg.MODEL.BORDER_HEAD.LOSS_WEIGHT = 1.0
    cfg.MODEL.BORDER_HEAD.BCE_WEIGHT = 1.0
    cfg.MODEL.BORDER_HEAD.DICE_WEIGHT = 1.0
    cfg.MODEL.BORDER_HEAD.POS_WEIGHT = 8.0

    cfg.MODEL.INSTANCE_MASK_REFINE = CN()
    cfg.MODEL.INSTANCE_MASK_REFINE.ENABLED = False
    cfg.MODEL.INSTANCE_MASK_REFINE.FREEZE_BASE = False
    cfg.MODEL.INSTANCE_MASK_REFINE.BACKBONE_DOWNSCALE_FACTOR = 0.5
    cfg.MODEL.INSTANCE_MASK_REFINE.HIDDEN_DIM = 256
    cfg.MODEL.INSTANCE_MASK_REFINE.IMAGE_HIDDEN_DIM = 64
    cfg.MODEL.INSTANCE_MASK_REFINE.FULL_RES_HIDDEN_DIM = 128
    cfg.MODEL.INSTANCE_MASK_REFINE.LOSS_WEIGHT = 1.0
    cfg.MODEL.INSTANCE_MASK_REFINE.MASK_WEIGHT = 5.0
    cfg.MODEL.INSTANCE_MASK_REFINE.DICE_WEIGHT = 5.0
    ...
    cfg.MODEL.MaskDINO.TEST.BOX_INFERENCE_SOURCE = "pred"
    cfg.MODEL.MaskDINO.TEST.BOX_EVAL_SOURCES = ["pred"]
    cfg.MODEL.MaskDINO.TEST.MASK_INFERENCE_SOURCE = "auto"
    cfg.MODEL.MaskDINO.TEST.MASK_EVAL_SOURCES = ["auto"]
    ...
    cfg.INPUT.BORDER_SEMANTIC = CN()
    cfg.INPUT.BORDER_SEMANTIC.BINARY_FROM_255 = False
    cfg.INPUT.BORDER_SEMANTIC.THRESHOLD = 127
    cfg.INPUT.BORDER_SEMANTIC.UPSCALE_FACTOR = 1.0
    cfg.INPUT.BORDER_SEMANTIC.FIXED_SIZE = 0
    cfg.INPUT.BORDER_SEMANTIC.PAD_VALUE = 255
    cfg.INPUT.BORDER_SEMANTIC.DILATE_KERNEL = 0
